...
const RestaurantDashboard = () => {
  ...
  const handleCloseRestaurantDialog = () => {
    ...
    setRestaurantFormData({
      name: '', description: '', cuisine: '', address: '', phone: '', openingHours: '', minOrder: '', deliveryTime: '',deliveryFee: '', image: '', isOpen: true,});
  };
  ...
  const handleOpenDialog = (item = null) => {
    if (item) {
      ...
      setMenuFormData({name: '',description: '',price: '', category: '', image: '',isAvailable: true, preparationTime: 15,});
    }
...
const handleCloseDialog = () => {
    ...
    setSelectedItem(null);
    setMenuFormData({
      name: '',description: '', price: '', category: '', image: '', isAvailable: true, preparationTime: 15,});
  };
  ...
  return (
    <Container 
      ...
      <Dialog 
        ...
        fullWidth
        PaperProps={{
          sx: { background: 'rgba(30, 30, 30, 0.98)', backdropFilter: 'blur(10px)', border: `1px solid rgba(255, 255, 255, 0.1)`, boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)', },
        }}>
        <DialogTitle 
          sx={{  color: 'rgba(255, 255, 255, 0.95)', fontWeight: 600, letterSpacing: '0.5px', borderBottom: '1px solid rgba(255, 255, 255, 0.1)', pb: 2, }}
        >
          Add New Restaurant
        </DialogTitle>
          ...
          <DialogContent>
            {[
              ...
              <TextField
                ...
                rows={field.rows}
                sx={{ '& .MuiOutlinedInput-root': {color: 'rgba(255, 255, 255, 0.95)',
                    '& fieldset': { borderColor: 'rgba(255, 255, 255, 0.1)', },
                    '&:hover fieldset': { borderColor: 'rgba(255, 255, 255, 0.2)',},
                    '&.Mui-focused fieldset': {borderColor: '#E65100',boxShadow: '0 0 0 2px rgba(230, 81, 0, 0.2)',},
                  },
